...
public class UERNBet {
	...
	public static void main(String[] args) {
		 Evento quartasFinal1 = new Evento("Quartas de final da copa do mundo", "Brasil", "Croácia", 1.18, 1.8, 2.5);
	        ...
	        Evento semifinal1 = new Evento("Semifinal da copa do mundo", "Argentina", "Holanda", 1.4, 1.5, 1.9);
	        ...
	        semifinal1.setResultado(Resultado.EMPATE);

	        if (aposta1.getResultado() == semifinal1.getResultado()) {
	            System.out.println("O apostador ganhou R$ " + aposta1.calculaLucro(semifinal1));
	        } else {
